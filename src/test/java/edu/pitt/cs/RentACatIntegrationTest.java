...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		c3 = null;
		try{
			Method m = r.getClass().getDeclaredMethod("getCat", int.class); // using reflection
			m.setAccessible(true);
			Object returnValue = m.invoke(r, 2);
	...
	public void testGetCatNumCats3() {
		...
		try{
			...
			m.setAccessible(true);
			Object returnValue = m.invoke(r, 2);
			Cat returnValue1 = (Cat)returnValue;
			assertNotNull(returnValue1);
			assertEquals(2, returnValue1.getId());
